...
if __name__=="__main__":
	...
	# Logistic regression
	X_train, X_test, y_train, y_test = train_test_split(data['GPA'], data['Program'],data['Return'], test_size=1)# test_size=0.50,random_state=101
	...
	# Count data
	sns.countplot(x='Return',data=data,palette='RdBu_r')

	plt.figure(3)
	sns.set_style('whitegrid')
	sns.countplot(x='Return',hue='Program',data=data,palette='RdBu_r')
