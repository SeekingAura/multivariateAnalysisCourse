...
if __name__=="__main__":
	keyX1="Months_Since_Last_service"
	keyX2="Type_of_Repair"
	keyY="Repair_Time_hours"

	data = pd.read_csv('ejemplo johnson.csv')
	print(data)
	#print (data)
	# x1 barra
	...
	results = ols(formula=keyY+' ~ '+keyX1+" + "+keyX2, data=data).fit()
